...
class Global():
    ...
    def path_map(key):
        ...
        # ---------------- Joana -----------------
        path_dict['python_root'] = '/nfs/nhome/live/jmagraner/gatsby-hackathon-seizure/code/python'
        path_dict['clips_folder'] = '/nfs/data3/kaggle_seizure/clips/clips_notest/'
        path_dict['clips_folder_initial'] = '/nfs/data3/kaggle_seizure/clips/'
        path_dict['clips_folder_prediction'] = '/nfs/data3/kaggle_prediction_ds/'
        ...
        path_dict['slurm_jobs_folder'] = '/nfs/nhome/live/jmagraner/Desktop/kaggle_slurm/prediction/'
