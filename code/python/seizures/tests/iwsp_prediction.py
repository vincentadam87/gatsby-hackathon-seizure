...
if __name__ == "__main__":
    ...
    sav_path = '/nfs/nhome/live/jmagraner/gatsby-hackathon-seizure/results/kaggle_prediction/'
    if not os.path.exists(sav_path):
        os.makedirs(sav_path)

    cluster = 'on'
    type = 'slurm'
    maxruntime = 5    # in days
    ...
    if cluster == 'on':
        ...
        batch_parameters = BatchClusterParameters(
                    ...
                    max_walltime=60*60*24*maxruntime,
                    nodes = 3,
    ...
    # let the engine finish its business
        ...
        for patient in patients:
            ...
            pickle.dump( result_list, open( sav_path+"pred_seq_result_"+patient+".p", "wb" ) )
